...
// ToBig_Int maps a []Uint8 to a []Big_Int.
func (MapUint8) ToBig_Int(aa []uint8, mapFn func(uint8) big.Int) []big.Int {
	bb := []big.Int{}
	for _, a := range aa {
		bb = append(bb, mapFn(a))
	}
...
// ToBig_Float maps a []Uint8 to a []Big_Float.
func (MapUint8) ToBig_Float(aa []uint8, mapFn func(uint8) big.Float) []big.Float {
	bb := []big.Float{}
	for _, a := range aa {
		bb = append(bb, mapFn(a))
	}
...
// ToBig_Rat maps a []Uint8 to a []Big_Rat.
func (MapUint8) ToBig_Rat(aa []uint8, mapFn func(uint8) big.Rat) []big.Rat {
	bb := []big.Rat{}
	for _, a := range aa {
		bb = append(bb, mapFn(a))
	}
