...
// ToBig_Int maps a []Int to a []Big_Int.
func (MapInt) ToBig_Int(aa []int, mapFn func(int) big.Int) []big.Int {
	bb := []big.Int{}
	for _, a := range aa {
		bb = append(bb, mapFn(a))
	}
...
// ToBig_Float maps a []Int to a []Big_Float.
func (MapInt) ToBig_Float(aa []int, mapFn func(int) big.Float) []big.Float {
	bb := []big.Float{}
	for _, a := range aa {
		bb = append(bb, mapFn(a))
	}
...
// ToBig_Rat maps a []Int to a []Big_Rat.
func (MapInt) ToBig_Rat(aa []int, mapFn func(int) big.Rat) []big.Rat {
	bb := []big.Rat{}
	for _, a := range aa {
		bb = append(bb, mapFn(a))
	}
