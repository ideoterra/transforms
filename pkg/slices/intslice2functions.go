...
func IntSlice2Fold(aa IntSlice2, acc IntSlice, folder func(a, acc IntSlice) IntSlice) IntSlice2 {
	return FoldI(aa, acc, func(_ int64, a, acc IntSlice) IntSlice { return folder(a, acc) })
}
...
//    folder: acc + sourceNode
//    Fold(aa, acc, folder) -> [11]
func IntSlice2FoldI(aa IntSlice2, acc IntSlice, folder func(i int64, a, acc IntSlice) IntSlice) IntSlice2 {
	accumulation := acc
	for i, a := range aa {
...
func IntSlice2ForEachC(aa IntSlice2, c int, fn func(a IntSlice, cancelPending func() bool) shared.Continue) {
	if c < 0 {
...
// the head.
func IntSlice2ForEachR(aa IntSlice2, fn func(IntSlice) shared.Continue) {
	for i := len(aa) - 1; i >= 0; i-- {
		if !fn(aa[i]) {
			return
		}
...
func IntSlice2Group(aa IntSlice2, grouper func(IntSlice) int64) []IntSlice2 {
	return GroupI(aa, func(_ int64, a IntSlice) int64 { return grouper(a) })
}
...
func IntSlice2GroupI(aa IntSlice2, grouper func(int64, IntSlice) int64) []IntSlice2 {
...
func IntSlice2Intersection(aa, bb IntSlice2, equality Equality) IntSlice2 {
	cc := IntSlice2{}
	ForEach(aa, func(a IntSlice) shared.Continue {
		ForEach(bb, func(b IntSlice) shared.Continue {
			if equality(a, b) && !Any(cc, func(c IntSlice) bool { return equality(a, c) }) {
				Append(&cc, a)
			}
...
func IntSlice2removeIntersections(aa, bb IntSlice2, equality Equality) (IntSlice2, IntSlice2) {
	aa1 := Clone(aa)
	bb1 := Clone(bb)
...
func IntSlice2ItemFuzzy(aa IntSlice2, i int64) IntSlice2 {
	if Empty(aa) {
		return IntSlice2{}
	}
	if i < 0 {
...
func IntSlice2Last(aa IntSlice2, test Test) IntSlice2 {
	bb := IntSlice2{}
	ForEachR(aa, func(a IntSlice) shared.Continue {
		if test(a) {
			Append(&bb, a)
...
func IntSlice2generate(n int64, aa IntSlice2, acc *[]IntSlice2) {
	if n == 1 {
		*acc = append(*acc, aa)
		return
	}
...
// nothing.
func IntSlice2RemoveAt(aa *IntSlice2, i int64) {
...
// returns false.
func IntSlice2SkipWhile(aa *IntSlice2, test Test) {
...
// rest of the slice.
func IntSlice2TakeWhile(aa *IntSlice2, test Test) {
